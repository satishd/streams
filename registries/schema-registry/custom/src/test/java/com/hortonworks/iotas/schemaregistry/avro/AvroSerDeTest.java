...
public class AvroSerDeTest {
    ...
    @Test
    public void testAvroSerDeApis() {
        Map<String, Object> event = createEvent();

        AvroSerializer<Map<String, Object>> avroSerializer = new AvroSerializer<>();
        byte[] serializedEvent = avroSerializer.serialize(event, schema);

        AvroDeserializer<Map<String, Object>> avroDeserializer = new AvroDeserializer<>();
        Map<String, Object> deserializedEvent = avroDeserializer.deserialize(new ByteArrayInputStream(serializedEvent), schema);
