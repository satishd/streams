...
public class AtlasStorageManager implements StorageManager {
    ...
    public <T extends Storable> T remove(StorableKey key) throws StorageException {
        ...
        try {
            ...
            Collection<ITypedReferenceableInstance> instances = atlasMetadataService.remove(key.getNameSpace(),
            ...
            // currently atlas does not return any entity info while deleting.
