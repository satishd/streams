...
public class AtlasMetadataService {
    ...
    private List<ITypedReferenceableInstance> _deleteEntities(Collection<String> entities) throws AtlasException {
        try {
            AtlasClient.EntityResult entityResult = metadataService.deleteEntities(Lists.newArrayList(entities));
            // entityResult contains only ids but not the actual entities.
            List<ITypedReferenceableInstance> deletedEntities = RequestContext.get().getDeletedEntities();
    ...
    public Collection<ITypedReferenceableInstance> remove(String type, Map<String, Object> attributes) throws AtlasException {
        ...
        Collection<String> entities = getEntityIds(type, attributes);
        ...
        List<ITypedReferenceableInstance> deletedEntities = _deleteEntities(entities);
