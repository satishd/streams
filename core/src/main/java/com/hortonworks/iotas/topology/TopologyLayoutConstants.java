...
public final class TopologyLayoutConstants {
    ...
    // json keys
    public final static String JSON_KEY_TRANSFORMATION_CLASS = "transformationClass";
    ...
    public final static String JSON_KEY_MAPPER_IMPL = "hBaseMapperImplClassName";
    ...
    public final static String JSON_KEY_FILE_NAME_FORMAT_IMPL = "filenameFormatImpl";
    ...
    public final static String JSON_KEY_ROTATION_POLICY_IMPL = "rotationPolicyImpl";
    ...
    public final static String JSON_KEY_USE_START_OFFSET_IF_OFFSET_OUT_OF_RANGE = "useStartOffsetTimeIfOffsetOutOfRange";
