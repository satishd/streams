...
CREATE TABLE IF NOT EXISTS jars ("id" BIGINT NOT NULL, "name" VARCHAR(256) ,"version" BIGINT, "className" VARCHAR , "auxiliaryInfo" VARCHAR ,"storedFileName" VARCHAR , "timestamp"  BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS sequence_table ("id" VARCHAR, "datasources" BIGINT, "datafeeds" BIGINT, "parser_info" BIGINT, "topologies" BIGINT, "topology_components" BIGINT, "tag" BIGINT,  CONSTRAINT pk PRIMARY KEY ("id"))
