 ...
 *
 */
public abstract class JoinProcessor extends IotasProcessor {
    ...
    protected Result joinEvents(Iterator<? extends IotasEvent> iotasEvents) {
        return null;
    }
    ...
    public Result execute(IotasEvent iotasEvent) {
