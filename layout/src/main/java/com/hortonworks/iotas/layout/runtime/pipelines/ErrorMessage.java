...
public class ErrorMessage {
     ...
     */
    public final ActionRuntime.Result resultEvent;

    public ErrorMessage(Long componentId, String error, List<IotasEvent> receivedEvents, ActionRuntime.Result resultEvent) {
